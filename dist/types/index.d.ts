...
export type ChangeCategory = 'breaking' | 'feat' | 'fix' | 'perf' | 'refactor' | 'docs' | 'style' | 'test' | 'build' | 'ci' | 'chore' | 'revert' | 'deps';
...
export interface ChangelogValidationIssue {
    /** Type of issue */
    type: 'missing-header' | 'invalid-version' | 'missing-section' | 'duplicate-entry' | 'invalid-format';
    /** Severity level */
